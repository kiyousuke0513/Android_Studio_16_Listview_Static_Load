package com.example.listview_static_load;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final AdapterView.OnItemClickListener listView_OnItemClickListener = new AdapterView.OnItemClickListener(){
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            {
                public void onTick(long millisUntilFinished) {textView_MSG.setVisibility(View.VISIBLE);}
                public void onFinish() {textView_MSG.setVisibility(View.INVISIBLE);}
            }.start();
        }
    };
}